---
layout: post
title: Minimum Sub-Sampling Rate in Practice
date: 2017-02-25 11:12:00-0400
description: An impressive example of the minimum sub-sampling rate needed for accurate low-rank matrix completion recovery.
---


<img  src="{{site.baseurl}}/assets/img/post-MinSubSamplingRate.png" >
<!-- <img  src="../../../assets/img/post-MinSubSamplingRate.png" > -->
